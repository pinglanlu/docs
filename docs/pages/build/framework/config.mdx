...
:::note
Note that the `domain` object here is incomplete and should not be used directly in your code. See [Accessing config values](/build/framework/config#accessing-config-values).
:::
